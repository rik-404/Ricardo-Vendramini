...
export const terminalCommands = {
  ...
  help: [
    ...
    "  timewalker - Viagem no tempo! Transforme o site na Web Retrô dos anos 90/2000 ⏳",
    "  clean    - Limpeza Total: deixa o site 100% limpo 🧹",
...
export const terminalCommandsEn = {
  ...
  help: [
    ...
    "  timewalker - Time Travel: transform the site into 90s/2000s Retro Web ⏳",
