...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      {/* Floating Card Container in Apple Titanium Style */}
      <div className="relative overflow-hidden rounded-[2.5rem] bg-zinc-950/90 border border-white/15 backdrop-blur-2xl p-6 sm:p-10 md:p-12 shadow-2xl group transition-[border-color,box-shadow] duration-200 hover:border-white/30">
        
        {/* Ambient Subtle Glows */}
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-white/5 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-zinc-500/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative z-10">
          ...
          >
            <img
              ...
              className="w-11 h-11 object-contain filter drop-shadow-[0_0_10px_rgba(255,255,255,0.2)] group-hover/brand:scale-110 transition-transform"
            />
            <div className="flex flex-col text-left">
              <div className="flex items-center gap-2 text-white font-extrabold tracking-wider text-xl sm:text-2xl">
                <span>
                  RICARDO<span className="text-zinc-400">.DEV</span>
                </span>
                <span className="w-2.5 h-2.5 rounded-full bg-white animate-pulse shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
              </div>
              <span className="text-xs font-mono text-zinc-400 flex items-center gap-1 group-hover/brand:underline">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-white/5 border border-white/15 hover:bg-white/10 hover:border-white/30 text-white transition-colors duration-300 shadow-md group/app backdrop-blur-md"
            >
              ...
              <div className="flex flex-col text-left">
                <span className="text-[10px] uppercase tracking-wider text-zinc-400 font-mono font-medium leading-none mb-1">
                  Empresa
                </span>
                <span className="text-xs sm:text-sm font-bold text-white leading-none group-hover/app:text-zinc-200 transition-colors flex items-center gap-1">
                  {personalInfo.companyName} <ArrowUpRight className="w-3 h-3" />
                </span>
              </div>
            </a>
            ...
            <a
              ...
              className="flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-white/5 border border-white/15 hover:bg-white/10 hover:border-white/30 text-white transition-colors duration-300 shadow-md group/app backdrop-blur-md"
            >
              <div className="p-1.5 rounded-xl bg-white/10 text-zinc-300">
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-xs sm:text-sm font-bold text-white leading-none group-hover/app:text-zinc-200 transition-colors">
                  Falar no WhatsApp
                </span>
              </div>
            </a>
        ...
        <div className="my-8 relative z-10">
          <p className="text-zinc-300 text-sm sm:text-base md:text-lg font-normal max-w-2xl leading-relaxed mb-6">
            {t('footer.mission')}
          </p>
        ...
        <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 relative z-10 text-xs sm:text-sm text-zinc-400">
          <div className="font-mono">
            © {currentYear} <span className="text-white font-bold">RICARDO<span className="text-zinc-400">.DEV</span></span>. {t('footer.rights')}
          </div>
            ...
            {socialButtons.map((item) => {
              ...
              return (
                <a
                  ...
                  className={`p-2 rounded-xl border border-white/10 bg-white/5 text-zinc-300 transition-colors duration-300 flex items-center justify-center group ${item.color}`}
                >
