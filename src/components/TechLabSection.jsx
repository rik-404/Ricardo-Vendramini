...
const techNodes = [
  { id: 'core', name: 'Linguagens & Core', icon: Atom, desc: 'JavaScript, TypeScript, Python, HTML5, CSS3, SQL', x: '10%', y: '30%' },
  { id: 'ui', name: 'Frameworks & UI', icon: Server, desc: 'React, Vite, TailwindCSS, Shadcn/UI, Canvas API, PWA', x: '30%', y: '20%' },
  { id: 'backend', name: 'Backend & Data', icon: Database, desc: 'Supabase, Node.js, PostgreSQL, REST API', x: '50%', y: '30%' },
  { id: 'os', name: 'Ferramentas & OS', icon: Terminal, desc: 'Linux, Git, VSCode, Pygame', x: '70%', y: '45%' },
  { id: 'deploy', name: 'Deploy & Infraestrutura', icon: Cloud, desc: 'Vercel, Hostinger, Git / GitHub', x: '90%', y: '30%' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0c140e] border border-[#10b981]/30 mb-4">
            ...
            <span className="text-xs font-mono text-[#00ff88] tracking-widest uppercase">Laboratório de Arquitetura</span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-white mb-4">
            Como as peças se <span className="text-gradient-green">conectam.</span>
          </h2>
          <p className="text-slate-400 max-w-2xl font-light text-base">
            Representação interativa da infraestrutura técnica e ecossistema de dados.
          </p>
        </div>
